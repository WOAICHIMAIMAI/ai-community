...
/**
 * 红包活动配置表
 * @TableName red_packet_activity_config
 */
@TableName(value = "red_packet_activity_config")
@Data
public class RedPacketActivityConfig implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        RedPacketActivityConfig other = (RedPacketActivityConfig) that;
